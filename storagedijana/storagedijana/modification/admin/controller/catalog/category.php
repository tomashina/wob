...
if (isset($this->request->get['search'])) {
			...
			$data['onpagetags'] = htmlspecialchars_decode(HTTPS_CATALOG.'index.php?route=extension/module/hb_onpage/generate_pages&page_type=category&authkey='.$this->config->get('hb_onpage_authkey'));
