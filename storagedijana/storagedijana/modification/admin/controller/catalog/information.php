...
class ControllerCatalogInformation extends Controller {
	...
	protected function getList() {
		...
		$data['footer'] = $this->load->controller('common/footer');
			...
			$data['onpagetags'] = htmlspecialchars_decode(HTTPS_CATALOG.'index.php?route=extension/module/hb_onpage/generate_pages&page_type=information&authkey='.$this->config->get('hb_onpage_authkey'));
