...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		foreach ($data['product_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', tag = '" . $this->db->escape($value['tag']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', h1 = '" . $this->db->escape($value['h1']) . "', h2 = '" . $this->db->escape($value['h2']) . "', image_alt = '" . $this->db->escape($value['image_alt']) . "', image_title = '" . $this->db->escape($value['image_title']) . "'");
		}
...
'h1'     => $result['h1'],'h2'     => $result['h2'],'image_alt'     => $result['image_alt'],'image_title'     => $result['image_title'],
				'tag'              => $result['tag']
			);
		}
