		...
		if ($this->config->get('config_account_id')) {
			...
			if ($this->config->get('mpgdpr_status') && $this->config->get('mpgdpr_acceptpolicy_customer')) {
				...
				if($this->config->get('mpgdpr_policy_customer')) {
					...
					if ($information_info) {
						$data['text_agree'] = sprintf($this->language->get('text_mpgdpr_agree'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('mpgdpr_policy_customer'), true), $information_info['title'], $information_info['title']);
					} else {
						$data['text_agree'] = '';
					}
				}
...
if(file_exists('catalog/model/extension/cmpltguagaf.php')) { 
				...
				$data['text_your_details'] .= $this->model_extension_cmpltguagaf->chkfunnel(1);
				
				$data['text_address_existing'] = $this->language->get('text_address_existing');
				$data['text_address_existing'] .= $this->model_extension_cmpltguagaf->chkfunnel(1); 
 			}
