...
class ModelCheckoutOrder extends Model {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			/*mpgdpr starts*/
			if (isset($this->session->data['mpgdpr_agree']) && $this->config->get('mpgdpr_status') && $this->config->get('mpgdpr_acceptpolicy_checkout')) {
				...
				if($this->config->get('mpgdpr_policy_checkout')) {
					...
					if ($information_info) {
						...
						$mpgdpr_policyacceptance_id = $this->model_mpgdpr_mpgdpr->addPolicyAcceptance($this->mpgdpr->codepolicyacceptcheckout, $insert_data);
						...
						$mpgdpr_requestlist_id = $this->model_mpgdpr_mpgdpr->addRequest($this->mpgdpr->codepolicyacceptcheckout, $request_data);
