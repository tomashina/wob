			...
			if ($this->config->get('mpgdpr_status') && $this->config->get('mpgdpr_acceptpolicy_customer')) {
				...
				if($this->config->get('mpgdpr_policy_customer')) {
					...
					if ($information_info) {
						...
						$mpgdpr_policyacceptance_id = $this->model_mpgdpr_mpgdpr->addPolicyAcceptance($this->mpgdpr->codepolicyacceptregister, $insert_data);
						...
						$mpgdpr_requestlist_id = $this->model_mpgdpr_mpgdpr->addRequest($this->mpgdpr->codepolicyacceptregister, $request_data);
