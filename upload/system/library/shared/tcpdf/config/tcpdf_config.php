 ...
 */
define('K_PATH_MAIN', DIR_SYSTEM . 'library/shared/tcpdf/');
...
if (defined('HTTPS_CATALOG')) {
    define('K_PATH_URL', HTTPS_CATALOG . 'library/shared/tcpdf/');
} else {
    define('K_PATH_URL', HTTPS_SERVER . 'library/shared/tcpdf/');
}
 ...
 */
define('K_PATH_CACHE', DIR_CACHE . 'tcpdf/');
