...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="button-circle"><i class="icon-refresh"></i></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="button-circle"><i class="icon-action-undo"></i></a>
                </td>
            </tr>
            <?php } ?>
            ...
            <tr>
              ...
              <td class="text-right hidden-xs hidden-sm"><?php echo $voucher['amount']; ?></td>
      ...
      <?php } ?>
      <?php if ($histories) { ?>
      <br /><h2 class="margin-b10"><?php echo $text_history; ?></h2>
      <table class="table table-bordered">
        <thead>
          <tr>
