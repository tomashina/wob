...
class ModelExtensionMpImporterExporterExportProduct extends \MpImporterExporter\Model {
...
if (VERSION <= '2.2.0.0') {
	class ModelMpImporterExporterExportProduct extends ModelExtensionMpImporterExporterExportProduct { }
}