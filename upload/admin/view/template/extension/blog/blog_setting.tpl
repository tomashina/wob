...
(!isset($blogsetting_post_thumbs_w)) ? $blogsetting_post_thumbs_w = 1140 : '';
(!isset($blogsetting_post_thumbs_h)) ? $blogsetting_post_thumbs_h = 700 : '';
...
(!isset($blogsetting_thumbs_h)) ? $blogsetting_thumbs_h = 700 : '';
(!isset($blogsetting_thumbs_w)) ? $blogsetting_thumbs_w = 1140 : '';
...
(!isset($blogsetting_rel_thumbs_w)) ? $blogsetting_rel_thumbs_w = 570 : '';
(!isset($blogsetting_rel_thumbs_h)) ? $blogsetting_rel_thumbs_h = 350 : '';
...
(!isset($blogsetting_rel_prod_width)) ? $blogsetting_rel_prod_width = 262 : '';
(!isset($blogsetting_rel_prod_height)) ? $blogsetting_rel_prod_height = 334 : '';
