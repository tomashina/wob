		 <div class="table-responsive">
			...
			<thead>
				<tr>
				<td width="1" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected404\']').prop('checked', this.checked);" /></td>
				<td class="text-left"><?php echo $column_error_url; ?> <span class="label label-danger">404</span> & <?php echo $column_redirect_url; ?></td>
				<td class="text-center"><?php echo $column_hits; ?></td>
				<td class="text-center"><?php echo $column_redirect_hits; ?></td>
				<td class="text-center"><?php echo $column_referrer; ?></td>
			...
			<tbody>
				...
				<tr>
				<td style="text-align: center;"><?php if ($record['selected404']) { ?>
                                <input type="checkbox" name="selected404[]" value="<?php echo $record['id']; ?>" checked="checked" />
                                <?php } else { ?>
                                <input type="checkbox" name="selected404[]" value="<?php echo $record['id']; ?>" />
                                <?php } ?></td>
				...
				<td class="text-center"><button type="button" class="btn btn-default" onclick="showreferrer('<?php echo $record['id']; ?>')"><i class="fa fa-eye" aria-hidden="true"></i> View Referrers</button></td>
				<td class="text-right">
