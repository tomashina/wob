...
//HUNTBEE START
if (isset($_SESSION['hbfm_access_key']) && isset($_SESSION['hbfm_store_url'])) {
	$token = $_SESSION['hbfm_access_key'];
	$base_url_override = $_SESSION['hbfm_store_url'];
}else{
	$token = '';
	$base_url_override = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'];
}
//HUNTBEE END
