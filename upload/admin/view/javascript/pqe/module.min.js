...
/*Custom*/
!function(bull5i,$,undefined){var jqXHR=null,success_timeout=5e3,default_texts={error_ajax_request:"An AJAX error occured!"},default_alert_classes={success:"alert-success",error:"alert-danger",warning:"alert-warning",info:"alert-info"},default_alert_icons={success:"fa-check-circle",error:"fa-times-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"};bull5i.success_timeout=success_timeout,bull5i.texts="undefined"!=typeof bull5i.texts?$.extend(default_texts,bull5i.texts):default_texts,bull5i.alert_classes="undefined"!=typeof bull5i.alert_classes?$.extend(default_alert_classes,bull5i.alert_classes):default_alert_classes,bull5i.alert_icons="undefined"!=typeof bull5i.alert_icons?$.extend(default_alert_icons,bull5i.alert_icons):default_alert_icons,bull5i.onBeforeSend==undefined&&(bull5i.onBeforeSend=function(t,e){t&&(t.css("display","block"),setTimeout(function(){t.addClass("in")},0)),$("fieldset",e).prop("disabled",!0)}),bull5i.onComplete==undefined&&(bull5i.onComplete=function(t,e){function a(){t.css("display","none"),l.resolve()}var l=$.Deferred();return t?(t.removeClass("in"),$.support.transition&&t.hasClass("fade")?t.one($.support.transition.end,a).emulateTransitionEnd(500):a()):l.resolve(),$("fieldset",e).attr("disabled",!1),l.promise()}),bull5i.display_alert==undefined&&(bull5i.display_alert=function(t,e,a,l,i){var s,l=l!=undefined?l:1e4,i=i!=undefined?i:!0,n=t||$("#alerts"),o=[];e&&n.length&&(i&&(o=$.map($(".alert",n),function(t){var e=$.Deferred();return $(t).alert("close").on("closed.bs.alert",function(){e.resolve()}),e.promise()})),$.when.apply(null,o).done(function(){a in bull5i.alert_classes||(a="error"),s=$("<div/>",{"class":"alert "+bull5i.alert_classes[a]+" fade"}).html(e).prepend($("<i/>",{"class":"fa "+bull5i.alert_icons[a]})).prepend($("<button/>",{type:"button","class":"close","data-dismiss":"alert","aria-hidden":"true"}).html("&times;")),s=s.appendTo(n),setTimeout(function(){s.addClass("in")},0),l&&setTimeout(function(){s.alert("close")},l)}))}),bull5i.display_alerts==undefined&&(bull5i.display_alerts=function(t,e,a){var e=e!=undefined?e:!0,l=l!=undefined?l:$("#alerts");t&&$.each(t,function(t,l){"object"==typeof l?$.each(l,function(l,i){i&&(bull5i.display_alert(a,i,t,"success"==t?bull5i.success_timeout:0,e),e=!1)}):l&&(bull5i.display_alert(a,l,t,"success"==t?bull5i.success_timeout:0,e),e=!1)})}),bull5i.observable_object_methods=function(){this.hasError=function(){var t=this,e=!1;for(var a in t)ko.isObservable(t[a])&&"function"==typeof t[a].hasError&&(e|=t[a].hasError());return e},this.applyErrors=function(t){var e=this;for(var a in e)ko.isObservable(e[a])&&("function"==typeof e[a].applyErrors?e[a].applyErrors(t.hasOwnProperty(a)?t[a]:{}):("function"==typeof e[a].hasError&&ko.isWriteableObservable(e[a].hasError)&&e[a].hasError(t.hasOwnProperty(a)),"function"==typeof e[a].errorMsg&&ko.isWriteableObservable(e[a].errorMsg)&&e[a].errorMsg(t.hasOwnProperty(a)?t[a]:"")))},this.updateValues=function(t){var e=this;for(var a in e)ko.isWriteableObservable(e[a])&&t.hasOwnProperty(a)&&("function"==typeof e[a].updateValues?e[a].updateValues(t[a]):$.isArray(e[a]())?window&&window.console&&window.console.log&&window.console.log("Observable Array '"+a+"' missing updateValues method"):e[a](t[a]))}},bull5i.activateTab=function(t){activeTab=t&&$("[href="+t+"]"),activeTab&&(activeTab.parents(".tab-pane").not(".active").each(function(){var t=$("[href=#"+this.id+"]");t&&t.tab("show")}),activeTab.tab("show").trigger("shown.bs.tab"))},$(function(){function ajax_success(data){var dismiss=!0;if(data){if(this.vm&&data.values&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].updateValues&&bull5i.view_models[this.vm].updateValues(data.values),this.vm&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].applyErrors&&bull5i.view_models[this.vm].applyErrors(data.errors?data.errors:{}),data.msg&&bull5i.display_alert&&(bull5i.display_alert(this.alerts,data.msg,"success",success_timeout),dismiss=!1),bull5i.display_alerts(data.alerts,dismiss,this.alerts),data.callback)try{eval(data.callback)}catch(e){}data.reload?window.location.reload(!0):data.url&&(window.location=data.url),this.dfd&&this.dfd.resolve()}}function ajax_fail(t,e,a){bull5i.display_alert&&bull5i.display_alert(this.alerts,bull5i.texts.error_ajax_request,"error",0),this.dfd&&this.dfd.reject(),window&&window.console&&window.console.log&&window.console.log(t,e,a)}function ajax_always(t,e,a){bull5i.onComplete(this.overlay,this.context),this.btn&&(this.btn.data("loading-text")?this.btn.button("reset"):this.btn.prop("disabled",!1))}window.prettyPrint&&prettyPrint(),$("body").on("click",".modal-footer .cancel",function(t){jqXHR&&jqXHR.abort()}).on("click","#btn-save",function(t){var e=this,a=$($(this).data("form")),l={self:e,btn:$(this),form:a,url:$(this).data("url"),alerts:$("#alerts"),context:$($(this).data("context"))};t.preventDefault(),l.url&&l.form&&(l.btn.data("loading-text")?l.btn.button("loading"):l.btn.prop("disabled",!0),l.form.attr("action",l.url).submit())}).on("click","#btn-apply",function(t){var e=this,a={self:e,btn:$(this),url:$(this).data("url"),form:$($(this).data("form")),alerts:$("#alerts"),context:$($(this).data("context")),overlay:$($(this).data("overlay")),vm:$(this).data("vm")};t.preventDefault(),a.url&&$.ajax({type:"POST",url:a.url,dataType:"json",data:a.form.serialize(),beforeSend:function(){bull5i.onBeforeSend(a.overlay,a.context),a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0)}}).done($.proxy(ajax_success,a)).fail($.proxy(ajax_fail,a)).always($.proxy(ajax_always,a))}).on("click","#btn-cancel,.btn-nav-link",function(t){var e={btn:$(this),url:$(this).data("url")||this.href};t.preventDefault(),e.url&&(e.btn.data("loading-text")?e.btn.button("loading"):e.btn.prop("disabled",!0),window.location=e.url)}).on("click","#btn-upgrade,#btn-fix-db",function(t){var e=this,a={self:e,btn:$(this),url:$(this).data("url"),form:$($(this).data("form")),alerts:$("#alerts"),context:$($(this).data("context")),overlay:$($(this).data("overlay"))};t.preventDefault(),a.url&&$.ajax({type:"POST",url:a.url,dataType:"json",beforeSend:function(){bull5i.onBeforeSend(a.overlay,a.context),a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0)}}).done($.proxy(ajax_success,a)).fail($.proxy(ajax_fail,a)).always(function(t,e,l){ajax_always.call(a,t,e,l),t&&t.success?a.btn.remove():a.btn.data("loading-text")?a.btn.button("reset"):a.btn.prop("disabled",!1)})}).on("click","#btn-refresh-services",function(t){var e=this,a={self:e,btn:$(this)};t.preventDefault(),bull5i.load_service_list&&(a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0),bull5i.load_service_list(!0).always(function(){a.btn.data("loading-text")?a.btn.button("reset"):a.btn.prop("disabled",!1)}))}).on("click","#legal_notice",function(t){t.preventDefault(),$($(this).attr("data-modal")).modal({show:!0,keyboard:!0})}).on("click","a.external-tab-link",function(t){var e=$(this).attr("data-target");t.preventDefault(),e&&(tabs=e.split(","),$.each(tabs,function(t,e){$("[href="+e+"]").trigger("click")}))}).on("click","button.purchase",function(t){var e=$(this).closest("tr.srvc"),a=e.find(".service").text(),l=e.find(".code").text(),i=e.find(".currency").text(),s=parseFloat(e.find(".price").text());a&&l&&i&&s&&window.open("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=support@opencart.ee&item_name="+a+"&item_number="+l+"&amount="+s+"&currency_code="+i+"&button_subtype=services&no_note=0&bn=OCEE_BuyNow_WPS_EE")}).on("shown.bs.tab",'a[data-toggle="tab"]',function(t){if(window.history&&history.pushState){var e=window.location.href.split("#")[0]+t.target.hash;window.location.href!=e&&(window.history.pushState(null,null,e),setTimeout(function(){window.scrollTo(0,0)},0))}else window.location.hash=t.target.hash,setTimeout(function(){window.scrollTo(0,0)},0);window.scrollTo(0,0)}),$("#alerts .alert.alert-success").each(function(t){var e=$(this);setTimeout(function(){e.alert("close")},8e3)}),$(window).on("hashchange",function(t){bull5i.activateTab(window.location.hash)})})}(window.bull5i=window.bull5i||{},jQuery);
