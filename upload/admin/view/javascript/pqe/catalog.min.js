...
/*Bootstrap datetimepicker v3.1.3*/
...
/*X-editable BS3 base*/
!function(t){"use strict";var e=t.fn.editableform.Constructor.prototype.initInput;t.extend(t.fn.editableform.Constructor.prototype,{initTemplate:function(){this.$form=t(t.fn.editableform.template),this.$form.find(".control-group").addClass("form-group"),this.$form.find(".editable-error-block").addClass("help-block")},initInput:function(){e.apply(this);var n=null===this.input.options.inputclass||this.input.options.inputclass===!1,i="input-sm",o="text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs".split(",");~t.inArray(this.input.type,o)&&(this.input.$input.addClass("form-control"),n&&(this.input.options.inputclass=i,this.input.$input.addClass(i)));for(var s=this.$form.find(".editable-buttons"),a=n?[i]:this.input.options.inputclass.split(" "),l=0;l<a.length;l++)"input-lg"===a[l].toLowerCase()&&s.find("button").removeClass("btn-sm").addClass("btn-lg")}}),t.fn.editableform.buttons='<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="glyphicon glyphicon-ok"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="glyphicon glyphicon-remove"></i></button>',t.fn.editableform.errorGroupClass="has-error",t.fn.editableform.errorBlockClass=null,t.fn.editableform.engine="bs3"}(window.jQuery),function(t){"use strict";t.extend(t.fn.editableContainer.Popup.prototype,{containerName:"popover",containerDataName:"bs.popover",innerCss:".popover-content",defaults:t.fn.popover.Constructor.DEFAULTS,initContainer:function(){t.extend(this.containerOptions,{trigger:"manual",selector:!1,content:" ",template:this.defaults.template});var e;this.$element.data("template")&&(e=this.$element.data("template"),this.$element.removeData("template")),this.call(this.containerOptions),e&&this.$element.data("template",e)},innerShow:function(){this.call("show")},innerHide:function(){this.call("hide")},innerDestroy:function(){this.call("destroy")},setContainerOption:function(t,e){this.container().options[t]=e},setPosition:function(){(function(){var t=this.tip(),e="function"==typeof this.options.placement?this.options.placement.call(this,t[0],this.$element[0]):this.options.placement,n=/\s?auto?\s?/i,i=n.test(e);i&&(e=e.replace(n,"")||"top");var o=this.getPosition(),s=t[0].offsetWidth,a=t[0].offsetHeight;if(i){var l=this.$element.parent(),r=e,p=document.documentElement.scrollTop||document.body.scrollTop,c="body"==this.options.container?window.innerWidth:l.outerWidth(),u="body"==this.options.container?window.innerHeight:l.outerHeight(),h="body"==this.options.container?0:l.offset().left;e="bottom"==e&&o.top+o.height+a-p>u?"top":"top"==e&&o.top-p-a<0?"bottom":"right"==e&&o.right+s>c?"left":"left"==e&&o.left-s<h?"right":e,t.removeClass(r).addClass(e)}var d=this.getCalculatedOffset(e,o,s,a);this.applyPlacement(d,e)}).call(this.container())}})}(window.jQuery);
/*X-editable combodate 1.0.5 */
!function(t){var e=function(e,i){return this.$element=t(e),this.$element.is("input")?(this.options=t.extend({},t.fn.combodate.defaults,i,this.$element.data()),void this.init()):void t.error("Combodate should be applied to INPUT element")};e.prototype={constructor:e,init:function(){this.map={day:["D","date"],month:["M","month"],year:["Y","year"],hour:["[Hh]","hours"],minute:["m","minutes"],second:["s","seconds"],ampm:["[Aa]",""]},this.$widget=t('<span class="combodate"></span>').html(this.getTemplate()),this.initCombos(),this.$widget.on("change","select",t.proxy(function(e){this.$element.val(this.getValue()).change(),this.options.smartDays&&(t(e.target).is(".month")||t(e.target).is(".year"))&&this.fillCombo("day")},this)),this.$widget.find("select").css("width","auto"),this.$element.hide().after(this.$widget),this.setValue(this.$element.val()||this.options.value)},getTemplate:function(){var e=this.options.template;return t.each(this.map,function(t,i){i=i[0];var o=new RegExp(i+"+"),n=i.length>1?i.substring(1,2):i;e=e.replace(o,"{"+n+"}")}),e=e.replace(/ /g,"&nbsp;"),t.each(this.map,function(t,i){i=i[0];var o=i.length>1?i.substring(1,2):i;e=e.replace("{"+o+"}",'<select class="'+t+'"></select>')}),e},initCombos:function(){for(var t in this.map){var e=this.$widget.find("."+t);this["$"+t]=e.length?e:null,this.fillCombo(t)}},fillCombo:function(t){var e=this["$"+t];if(e){var i="fill"+t.charAt(0).toUpperCase()+t.slice(1),o=this[i](),n=e.val();e.empty();for(var s=0;s<o.length;s++)e.append('<option value="'+o[s][0]+'">'+o[s][1]+"</option>");e.val(n)}},fillCommon:function(t){var e,i=[];if("name"===this.options.firstItem){e=moment.relativeTime||moment.langData()._relativeTime;var o="function"==typeof e[t]?e[t](1,!0,t,!1):e[t];o=o.split(" ").reverse()[0],i.push(["",o])}else"empty"===this.options.firstItem&&i.push(["",""]);return i},fillDay:function(){var t,e,i=this.fillCommon("d"),o=-1!==this.options.template.indexOf("DD"),n=31;if(this.options.smartDays&&this.$month&&this.$year){var s=parseInt(this.$month.val(),10),a=parseInt(this.$year.val(),10);isNaN(s)||isNaN(a)||(n=moment([a,s]).daysInMonth())}for(e=1;n>=e;e++)t=o?this.leadZero(e):e,i.push([e,t]);return i},fillMonth:function(){var t,e,i=this.fillCommon("M"),o=-1!==this.options.template.indexOf("MMMM"),n=-1!==this.options.template.indexOf("MMM"),s=-1!==this.options.template.indexOf("MM");for(e=0;11>=e;e++)t=o?moment().date(1).month(e).format("MMMM"):n?moment().date(1).month(e).format("MMM"):s?this.leadZero(e+1):e+1,i.push([e,t]);return i},fillYear:function(){var t,e,i=[],o=-1!==this.options.template.indexOf("YYYY");for(e=this.options.maxYear;e>=this.options.minYear;e--)t=o?e:(e+"").substring(2),i[this.options.yearDescending?"push":"unshift"]([e,t]);return i=this.fillCommon("y").concat(i)},fillHour:function(){var t,e,i=this.fillCommon("h"),o=-1!==this.options.template.indexOf("h"),n=(-1!==this.options.template.indexOf("H"),-1!==this.options.template.toLowerCase().indexOf("hh")),s=o?1:0,a=o?12:23;for(e=s;a>=e;e++)t=n?this.leadZero(e):e,i.push([e,t]);return i},fillMinute:function(){var t,e,i=this.fillCommon("m"),o=-1!==this.options.template.indexOf("mm");for(e=0;59>=e;e+=this.options.minuteStep)t=o?this.leadZero(e):e,i.push([e,t]);return i},fillSecond:function(){var t,e,i=this.fillCommon("s"),o=-1!==this.options.template.indexOf("ss");for(e=0;59>=e;e+=this.options.secondStep)t=o?this.leadZero(e):e,i.push([e,t]);return i},fillAmpm:function(){var t=-1!==this.options.template.indexOf("a"),e=(-1!==this.options.template.indexOf("A"),[["am",t?"am":"AM"],["pm",t?"pm":"PM"]]);return e},getValue:function(e){var i,o={},n=this,s=!1;return t.each(this.map,function(t){if("ampm"!==t){var e="day"===t?1:0;return o[t]=n["$"+t]?parseInt(n["$"+t].val(),10):e,isNaN(o[t])?(s=!0,!1):void 0}}),s?"":(this.$ampm&&(o.hour=12===o.hour?"am"===this.$ampm.val()?0:12:"am"===this.$ampm.val()?o.hour:o.hour+12),i=moment([o.year,o.month,o.day,o.hour,o.minute,o.second]),this.highlight(i),e=void 0===e?this.options.format:e,null===e?i.isValid()?i:null:i.isValid()?i.format(e):"")},setValue:function(e){function i(e,i){var o={};return e.children("option").each(function(e,n){var s,a=t(n).attr("value");""!==a&&(s=Math.abs(a-i),("undefined"==typeof o.distance||s<o.distance)&&(o={value:a,distance:s}))}),o.value}if(e){var o="string"==typeof e?moment(e,this.options.format):moment(e),n=this,s={};o.isValid()&&(t.each(this.map,function(t,e){"ampm"!==t&&(s[t]=o[e[1]]())}),this.$ampm&&(s.hour>=12?(s.ampm="pm",s.hour>12&&(s.hour-=12)):(s.ampm="am",0===s.hour&&(s.hour=12))),t.each(s,function(t,e){n["$"+t]&&("minute"===t&&n.options.minuteStep>1&&n.options.roundTime&&(e=i(n["$"+t],e)),"second"===t&&n.options.secondStep>1&&n.options.roundTime&&(e=i(n["$"+t],e)),n["$"+t].val(e))}),this.options.smartDays&&this.fillCombo("day"),this.$element.val(o.format(this.options.format)).change())}},highlight:function(t){t.isValid()?this.options.errorClass?this.$widget.removeClass(this.options.errorClass):this.$widget.find("select").css("border-color",this.borderColor):this.options.errorClass?this.$widget.addClass(this.options.errorClass):(this.borderColor||(this.borderColor=this.$widget.find("select").css("border-color")),this.$widget.find("select").css("border-color","red"))},leadZero:function(t){return 9>=t?"0"+t:t},destroy:function(){this.$widget.remove(),this.$element.removeData("combodate").show()}},t.fn.combodate=function(i){var o,n=Array.apply(null,arguments);return n.shift(),"getValue"===i&&this.length&&(o=this.eq(0).data("combodate"))?o.getValue.apply(o,n):this.each(function(){var o=t(this),s=o.data("combodate"),a="object"==typeof i&&i;s||o.data("combodate",s=new e(this,a)),"string"==typeof i&&"function"==typeof s[i]&&s[i].apply(s,n)})},t.fn.combodate.defaults={format:"DD-MM-YYYY HH:mm",template:"D / MMM / YYYY   H : mm",value:null,minYear:1970,maxYear:2015,yearDescending:!0,minuteStep:5,secondStep:1,firstItem:"empty",errorClass:null,roundTime:!0,smartDays:!1}}(window.jQuery),function(t){"use strict";var e=function(i){this.init("combodate",i,e.defaults),this.options.viewformat||(this.options.viewformat=this.options.format),i.combodate=t.fn.editableutils.tryParseJson(i.combodate,!0),this.options.combodate=t.extend({},e.defaults.combodate,i.combodate,{format:this.options.format,template:this.options.template})};t.fn.editableutils.inherit(e,t.fn.editabletypes.abstractinput),t.extend(e.prototype,{render:function(){this.$input.combodate(this.options.combodate),"bs3"===t.fn.editableform.engine&&this.$input.siblings().find("select").addClass("form-control"),this.options.inputclass&&this.$input.siblings().find("select").addClass(this.options.inputclass)},value2html:function(t,i){var o=t?t.format(this.options.viewformat):"";e.superclass.value2html.call(this,o,i)},html2value:function(t){return t?moment(t,this.options.viewformat):null},value2str:function(t){return t?t.format(this.options.format):""},str2value:function(t){return t?moment(t,this.options.format):null},value2submit:function(t){return this.value2str(t)},value2input:function(t){this.$input.combodate("setValue",t)},input2value:function(){return this.$input.combodate("getValue",null)},activate:function(){this.$input.siblings(".combodate").find("select").eq(0).focus()},autosubmit:function(){}}),e.defaults=t.extend({},t.fn.editabletypes.abstractinput.defaults,{tpl:'<input type="text">',inputclass:null,format:"YYYY-MM-DD",viewformat:null,template:"D / MMM / YYYY",combodate:null}),t.fn.editabletypes.combodate=e}(window.jQuery);
/*X-editable select2 */
!function(t){"use strict";var e=function(i){if(this.init("select2",i,e.defaults),i.select2=i.select2||{},this.sourceData=null,i.placeholder&&(i.select2.placeholder=i.placeholder),!i.select2.tags&&i.source){var s=i.source;t.isFunction(i.source)&&(s=i.source.call(i.scope)),"string"==typeof s?(i.select2.ajax=i.select2.ajax||{},i.select2.ajax.data||(i.select2.ajax.data=function(t){return{query:t}}),i.select2.ajax.results||(i.select2.ajax.results=function(t){return{results:t}}),i.select2.ajax.url=s):(this.sourceData=this.convertSource(s),i.select2.data=this.sourceData)}if(this.options.select2=t.extend({},e.defaults.select2,i.select2),this.isMultiple=this.options.select2.tags||this.options.select2.multiple,this.isRemote="ajax"in this.options.select2,this.idFunc=this.options.select2.id,"function"!=typeof this.idFunc){var n=this.idFunc||"id";this.idFunc=function(t){return t[n]}}this.formatSelection=this.options.select2.formatSelection,"function"!=typeof this.formatSelection&&(this.formatSelection=function(t){return t.text})};t.fn.editableutils.inherit(e,t.fn.editabletypes.abstractinput),t.extend(e.prototype,{render:function(){this.setClass(),this.isRemote&&this.$input.on("select2-loaded",t.proxy(function(t){this.sourceData=t.items.results},this)),this.isMultiple&&this.$input.on("change",function(){t(this).closest("form").parent().triggerHandler("resize")})},postrender:function(){if(this.options.select2.initSelection&&""!==this.$input.val()){var e=t(this.options.scope).data("editable").container.$form.data("editableform");e&&e.showLoading&&e.showLoading(),this.$input.on("select2-init-selection-done",t.proxy(function(){e&&e.showLoading&&e.showForm()},this))}},value2html:function(i,s){var n,o="",a=this;this.options.select2.tags?n=i:this.sourceData&&(n=t.fn.editableutils.itemsByValue(i,this.sourceData,this.idFunc)),t.isArray(n)?(o=[],t.each(n,function(t,e){o.push(e&&"object"==typeof e?a.formatSelection(e):e)})):n&&(o=a.formatSelection(n)),o=t.isArray(o)?o.join(this.options.viewseparator):o,e.superclass.value2html.call(this,o,s)},html2value:function(t){return this.options.select2.tags?this.str2value(t,this.options.viewseparator):null},value2input:function(e){if(t.isArray(e)&&(e=e.join(this.getSeparator())),this.$input.data("select2")?this.$input.val(e).trigger("change",!0):(this.$input.val(e),this.$input.select2(this.options.select2)),this.isRemote&&!this.isMultiple&&!this.options.select2.initSelection){var i=this.options.select2.id,s=this.options.select2.formatSelection;if(!i&&!s){var n=t(this.options.scope);if(!n.data("editable").isEmpty){var o={id:e,text:n.text()};this.$input.select2("data",o)}}}},input2value:function(){return this.$input.select2("val")},str2value:function(e,i){if("string"!=typeof e||!this.isMultiple)return e;i=i||this.getSeparator();var s,n,o;if(null===e||e.length<1)return null;for(s=e.split(i),n=0,o=s.length;o>n;n+=1)s[n]=t.trim(s[n]);return s},autosubmit:function(){this.$input.on("change",function(e,i){i||t(this).closest("form").submit()})},getSeparator:function(){return this.options.select2.separator||t.fn.select2.defaults.separator},convertSource:function(e){if(t.isArray(e)&&e.length&&void 0!==e[0].value)for(var i=0;i<e.length;i++)void 0!==e[i].value&&(e[i].id=e[i].value,delete e[i].value);return e},destroy:function(){this.$input.data("select2")&&this.$input.select2("destroy")}}),e.defaults=t.extend({},t.fn.editabletypes.abstractinput.defaults,{tpl:'<input type="hidden">',select2:null,placeholder:null,source:null,viewseparator:", "}),t.fn.editabletypes.select2=e}(window.jQuery);
/*X-editable BS Typeahead*/
!function(t){"use strict";var e=function(t){this.init("typeaheadjs",t,e.defaults)};t.fn.editableform.Constructor.prototype.render;t.fn.editableutils.inherit(e,t.fn.editabletypes.text),t.extend(e.prototype,{render:function(){this.renderClear(),this.setClass(),this.setAttr("placeholder"),this.$input.typeahead(this.options.typeahead.options,this.options.typeahead.dataset).on("typeahead:select typeahead:autocomplete",function(e,a){t(this).data("ta-selected",a),t(this).val()!=a.value&&t(this).typeahead("val",a.value)}).on("typeahead:close blur",function(){void 0==t(this).data("ta-selected")?t(this).typeahead("val",""):t(this).val()!=t(this).data("ta-selected").value&&(t(this).typeahead("val",""),t(this).removeData("ta-selected"))}).on("keydown.editable",function(e){13==e.which&&(void 0==t(this).data("ta-selected")||t(this).val()!=t(this).data("ta-selected").value)&&e.preventDefault()})},value2input:function(t){this.value=t,"function"==typeof this.options.value2input&&(t=this.options.value2input.call(this,t)),this.$input.val(t)},input2value:function(){if("function"==typeof this.options.input2value)return this.options.input2value.call(this,this.$input.val());var t=this.$input.data("ta-selected");return"undefined"!=typeof t?t.id:null},clear:function(){this.$clear.hide(),this.$input.typeahead("val",""),this.$input.focus()}}),e.defaults=t.extend({},t.fn.editabletypes.list.defaults,{tpl:'<input type="text">',typeahead:null,clear:!0,value2input:null,input2value:null}),t.fn.editabletypes.typeaheadjs=e}(window.jQuery);
/*X-editable ML edit*/
!function(t){"use strict";var i=function(t){this.init("multilingual_text",t,i.defaults)};t.fn.editableutils.inherit(i,t.fn.editabletypes.abstractinput),t.extend(i.prototype,{render:function(){var i=t.Deferred();return this.error=null,this.onSourceReady(function(){this.renderInput(),i.resolve()},function(t){this.error=t?t:this.options.sourceError,i.resolve()}),i.promise()},renderInput:function(){var i;if(this.$tpl.empty(),t.isArray(this.sourceData)){for(var s=0;s<this.sourceData.length;s++)i=t("<div/>",{"class":"form-group","data-lang":this.sourceData[s].lang}).append(t("<div/>",{"class":"input-group"}).append(t("<span/>",{"class":"input-group-addon",title:this.sourceData[s].title}).append(t("<img/>",{src:this.sourceData[s].image})),t("<input/>",{type:"text","class":"form-control",placeholder:this.sourceData[s].title,value:this.sourceData[s].value,"data-lang":this.sourceData[s].lang}))),this.$tpl.append(i);this.$input=this.$tpl.find(":input"),this.setClass(),this.value=this.input2value(),this.$input.on("keydown.editable",function(i){13===i.which&&(i.preventDefault(),t(this).closest("form").submit())})}},html2value:function(){return null},value2html:function(i,s,e,n){var a=t.Deferred(),r=function(){"function"==typeof e?e.call(s,i,this.sourceData,n):this.value2htmlFinal(i,s),a.resolve()};return null===i?r.call(this):this.onSourceReady(r,function(){a.resolve()}),a.promise()},value2str:function(i){return t.fn.editableutils.jsonStringify(i)},str2value:function(i){return"string"!=typeof i?i:t.fn.editableutils.tryParseJson(i,!0)},value2input:function(){},input2value:function(){var i=[];return this.$input.each(function(s,e){var n=t(e);i.push({lang:n.attr("data-lang"),value:n.val()})}),i},activate:function(){this.$input.filter(":input:first").focus()},autosubmit:function(){this.$input.keydown(function(i){13===i.which&&t(this).closest("form").submit()})},onSourceReady:function(i,s){var e;if(t.isFunction(this.options.source)?(e=this.options.source.call(this.options.scope),this.sourceData=null):e=this.options.source,this.options.sourceCache&&t.isArray(this.sourceData))return void i.call(this);try{e=t.fn.editableutils.tryParseJson(e,!1)}catch(n){return void s.call(this)}if("string"==typeof e){if(this.options.sourceCache){var a,r=e;if(t(document).data(r)||t(document).data(r,{}),a=t(document).data(r),a.loading===!1&&a.sourceData)return this.sourceData=a.sourceData,this.doPrepend(),void i.call(this);if(a.loading===!0)return a.callbacks.push(t.proxy(function(){this.sourceData=a.sourceData,this.doPrepend(),i.call(this)},this)),void a.err_callbacks.push(t.proxy(s,this));a.loading=!0,a.callbacks=[],a.err_callbacks=[]}var o;o="function"==typeof this.options.sourceOptions?this.options.sourceOptions.call(this.options.scope):t.fn.editableutils.tryParseJson(this.options.sourceOptions,!0);var u=t.extend({url:e,type:"get",cache:!1,dataType:"json",success:t.proxy(function(e){a&&(a.loading=!1),"function"==typeof this.options.sourceLoaded&&(e=this.options.sourceLoaded.call(this.options.scope,e)),this.sourceData=this.makeArray(e),t.isArray(this.sourceData)?(a&&(a.sourceData=this.sourceData,t.each(a.callbacks,function(){this.call()})),this.doPrepend(),i.call(this)):(s.call(this,e),a&&t.each(a.err_callbacks,function(){this.call()}))},this),error:t.proxy(function(){s.call(this),a&&(a.loading=!1,t.each(a.err_callbacks,function(){this.call()}))},this)},o);t.ajax(u)}else this.sourceData=this.makeArray(e),t.isArray(this.sourceData)?(this.doPrepend(),i.call(this)):s.call(this)},doPrepend:function(){null!==this.options.prepend&&void 0!==this.options.prepend&&(t.isArray(this.prependData)||(t.isFunction(this.options.prepend)&&(this.options.prepend=this.options.prepend.call(this.options.scope)),this.options.prepend=t.fn.editableutils.tryParseJson(this.options.prepend,!0),"string"==typeof this.options.prepend&&(this.options.prepend={"":this.options.prepend}),this.prependData=this.makeArray(this.options.prepend)),t.isArray(this.prependData)&&t.isArray(this.sourceData)&&(this.sourceData=this.prependData.concat(this.sourceData)))},makeArray:function(i){var s,e=[];if(!i||"string"==typeof i)return null;if("object"==typeof i&&i.hasOwnProperty("data")&&(i=i.data),t.isArray(i))for(var n=0;n<i.length;n++)s=i[n],"object"==typeof s&&(s.hasOwnProperty("lang")&&s.hasOwnProperty("value")&&s.hasOwnProperty("title")&&s.hasOwnProperty("image")?e.push(s):s.hasOwnProperty("lang")&&s.hasOwnProperty("value")&&e.push(t.extend(s,{title:"",image:""})));return e},option:function(t,i){this.options[t]=i,"source"===t&&(this.sourceData=null),"prepend"===t&&(this.prependData=null)}}),i.defaults=t.extend({},t.fn.editabletypes.abstractinput.defaults,{source:null,displayLanguage:!1,prepend:!1,sourceError:"Error loading source data",sourceCache:!1,sourceOptions:null,sourceLoaded:null,tpl:'<div class="multilingual-inputs"></div>',inputclass:""}),t.fn.editabletypes.multilingual_text=i,t.extend(t.fn.editableutils,{jsonStringify:window.JSON?JSON.stringify:function(i){var s=typeof i;if("object"!==s||null===i)return"string"===s&&(i='"'+i+'"'),i+"";var e,n,a=[],r=t.isArray(i);for(e in i)n=i[e],s=typeof n,"string"===s?n='"'+n+'"':"object"===s&&null!==n&&(n=_fnJsonString(n)),a.push((r?"":'"'+e+'":')+n);return(r?"[":"{")+a+(r?"]":"}")}})}(window.jQuery);
/*X-editable Image edit*/
!function(t){"use strict";var i=function(t){this.init("image",t,i.defaults)};t.fn.editableutils.inherit(i,t.fn.editabletypes.abstractinput),t.extend(i.prototype,{render:function(){this.$input=this.$tpl.find('input[name="value"]'),this.$tpl.find("button.clear-image").on("click",t.proxy(this.clearImage,this)).html(this.options.clearText),this.$tpl.find("button.browse-image").on("click",t.proxy(this.browseImage,this)).html(this.options.browseText)},clearImage:function(){this.$tpl.find('input[name="value"]').val(""),this.options.noImage?this.$tpl.find("img.display-image").attr("src",this.options.noImage):this.$tpl.find("img.display-image").attr("src","")},browseImage:function(){var i=this.input2value();if("function"==typeof this.options.chooseImage){var e=t(this.options.scope).data("editable").container.$form.data("editableform");e&&e.showLoading&&e.showLoading(),this.options.chooseImage.call(this,i,t.proxy(this.imageChosen,this))}},imageChosen:function(i){var e=t(this.options.scope).data("editable").container.$form.data("editableform");null!==i&&this.value2input(i),e&&e.showForm&&e.showForm()},html2value:function(){return null},value2html:function(i,e){var a=t(e).find("img"),n="object"==typeof i&&i.hasOwnProperty("thumbnail")?i.thumbnail:i;a.length?a.attr("src",n):$element.html(n)},value2str:function(t){return"object"==typeof t&&t.image?t.image:t},str2value:function(i){return"string"!=typeof i?i:t.fn.editableutils.tryParseJson(i,!0)},value2input:function(t){var i="object"==typeof t&&t.hasOwnProperty("thumbnail")?t.thumbnail:t,e="object"==typeof t&&t.hasOwnProperty("image")?t.image:t,a="object"==typeof t&&t.hasOwnProperty("title")?t.title:"",n="object"==typeof t&&t.hasOwnProperty("alt")?t.alt:"";this.$input.val(e),this.$tpl.find("img.display-image").attr("src",i).attr("alt",n).attr("title",a)},value2submit:function(t){return t.image},input2value:function(){var t={},i=this.$input.val(),e=this.$tpl.find("img.display-image").attr("src"),a=this.$tpl.find("img.display-image").attr("title"),n=this.$tpl.find("img.display-image").attr("alt");return t.image=i,t.thumbnail=e,t.title=a,t.alt=n,t}}),i.defaults=t.extend({},t.fn.editabletypes.abstractinput.defaults,{showbuttons:!0,tpl:'<div class="image-input"><div class="img"><a href="#" data-toggle="im" class="img-thumbnail img-relative" id="quick-edit-thumbnail"><div class="content-overlay"><span class="fa fa-2x fa-refresh fa-spin"></span></div><img src="" alt="" title="" class="display-image"></a><input type="hidden" name="value" value="" id="quick-edit-image" /></div><div class="btns"><button type="button" class="btn btn-default btn-xs clear-image"></button><button type="button" class="btn btn-default btn-xs browse-image"></button></div></div>',inputclass:"",clearText:"Clear Image",browseText:"Browse Image",noImage:"",chooseImage:null}),t.fn.editabletypes.image=i}(window.jQuery);
/*X-editable customization*/
!function(t){"use strict";var e=t.fn.editableform.Constructor.prototype.initInput,r=t.fn.editableform.Constructor.prototype.render;t.extend(t.fn.editableform.Constructor.prototype,{initInput:function(){"function"==typeof this.options.value&&(this.options.value=this.options.value.call(this.options.scope)),e.apply(this)},render:function(){var t=this;r.apply(this),t.input.value&&(t.value=t.input.value),this.$div.on("rendered",function(){t.value=t.input.value})},error:function(e){var r,o=this.$form.find(".control-group"),i=this.$form.find(".editable-error-block");if(e===!1)o.removeClass(t.fn.editableform.errorGroupClass),i.removeClass(t.fn.editableform.errorBlockClass).empty().hide();else{if(e){r=(""+e).split("\n");for(var n=0;n<r.length;n++)r[n]=t("<div>").html(r[n]).html();e=r.join("<br>")}o.addClass(t.fn.editableform.errorGroupClass),i.addClass(t.fn.editableform.errorBlockClass).html(e).show()}}}),t.extend(t.fn.editabletypes.select2.prototype,{value2str:function(e){var r="undefined"!=typeof this.options.separator?this.options.separator:this.getSeparator();return t.isArray(e)?e.sort().join(t.trim(r)):e}})}(jQuery);
/*Handlebars v2.0.0*/
...
/*Custom*/
!function(bull5i,$,undefined){var jqXHR=null,success_timeout=5e3,selected_state=[],default_texts={error_ajax_request:"An AJAX error occured!"},default_alert_classes={success:"alert-success",error:"alert-danger",warning:"alert-warning",info:"alert-info"},default_alert_icons={success:"fa-check-circle",error:"fa-times-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"};if(bull5i.debugging=!1,bull5i.clearCache=!1,bull5i.user_token="",bull5i.success_timeout=success_timeout,bull5i.params={},bull5i.texts=void 0!==bull5i.texts?$.extend(default_texts,bull5i.texts):default_texts,bull5i.alert_classes=void 0!==bull5i.alert_classes?$.extend(default_alert_classes,bull5i.alert_classes):default_alert_classes,bull5i.alert_icons=void 0!==bull5i.alert_icons?$.extend(default_alert_icons,bull5i.alert_icons):default_alert_icons,$.extend(jQuery.fn.dataTable.ext.classes,{sWrapper:"dataTables_wrapper dt-bootstrap"}),Number.prototype.round=function(e){return+(Math.round(this+"e+"+e)+"e-"+e)},ko.observableArray.fn.withIndex=function(e){var t=ko.computed(function(){var t=this()||[],a={};return ko.utils.arrayForEach(t,function(t){e?a[ko.utils.unwrapObservable(t[e])]=t:a[t]=t}),a},this);return this.findByKey=function(e){return t()[e]},this.keys=function(){return Object.keys(t())},this},ko.extenders.numeric=function(e,t){var a=ko.computed({read:e,write:function(a){var i,l=$.extend({precision:2,force:!0,context:this},t),n=e(),o=(i=a,!isNaN(parseFloat(i))&&isFinite(i)||l.force?(isNaN(a)?0:parseFloat(+a)).round(l.precision).toFixed(l.precision):a);o!==n?e(o):a!==n&&e.notifySubscribers(o)}}).extend({notify:"always"});return a(e()),a},ko.extenders.validate=function(e,t){var a=$.extend(!0,{message:"",context:this},t,{target:e});return e.validate=a.method=a.method!=undefined&&"function"==typeof a.method?$.proxy(a.method,a):$.proxy($.noop,a),e.hasError=ko.observable(!1).extend({notify:"always"}),e.errorMsg=ko.observable("").extend({notify:"always"}),a.method(e()),e.subscribe(a.method),e},ko.extenders.required=function(e,t){return t.target=e,t.method=t.method!=undefined&&"function"==typeof t.method?t.method:function(e){this.target.hasError(!e),this.target.errorMsg(e?"":this.message)},t.message=t.message!=undefined&&"string"==typeof t.message?t.message:"This field is required",ko.extenders.validate.call(this,e,t)},ko.extenders.hasError=function(e,t){var a=$.extend({check:!0,context:this},t);return e.hasError=ko.computed(function(){var t=!1;return a.check&&$.isArray(e())&&ko.utils.arrayForEach(e(),function(e){"function"==typeof e.hasError&&(t|=e.hasError())}),t}).extend({notify:"always"}),e},ko.extenders.applyErrors=function(e,t){$.extend({context:this},t);var a=function(e,t,a){"function"==typeof e.applyErrors?e.applyErrors(t?a:{}):("function"==typeof e.hasError&&ko.isWriteableObservable(e.hasError)&&e.hasError(t),"function"==typeof e.errorMsg&&ko.isWriteableObservable(e.errorMsg)&&e.errorMsg(t?a:""))};return e.applyErrors=function(t){ko.isObservable(e)&&($.isArray(e())?"function"==typeof e.findByKey&&"function"==typeof e.keys?$.each(e.keys(),function(i,l){a(e.findByKey(l),t.hasOwnProperty(l),t.hasOwnProperty(l)?t[l]:{})}):$.each(e(),function(e,i){a(i,t.hasOwnProperty(e),t.hasOwnProperty(e)?t[e]:{})}):a(e(),!!t,t||{}))},e},ko.bindingHandlers.tooltip={init:function(e,t){var a=ko.utils.unwrapObservable(t()),i={};ko.utils.extend(i,ko.bindingHandlers.tooltip.options),ko.utils.extend(i,a),$(e).tooltip(i),ko.utils.domNodeDisposal.addDisposeCallback(e,function(){$(e).tooltip("destroy")})},options:{trigger:"hover"}},ko.bindingHandlers.datetimepicker={init:function(e,t){var a=ko.utils.unwrapObservable(t()),i={};ko.utils.extend(i,ko.bindingHandlers.datetimepicker.options),ko.utils.extend(i,a),$(e).datetimepicker(i).on("dp.change",function(t){$(e).is(":input:not(:button)")?$(e).trigger("change"):$(e).find(":input:not(:button)").trigger("change")}),ko.utils.domNodeDisposal.addDisposeCallback(e,function(){$(e).datetimepicker("destroy")})},options:{}},ko.bindingHandlers.summernote=new function(){var e=!1;this.init=function(t,a,i){var l=a(),n=ko.utils.unwrapObservable(i()).value;$.extend(l,{disableDragAndDrop:!0,emptyPara:"",toolbar:[["style",["style"]],["font",["bold","underline","clear"]],["fontname",["fontname"]],["color",["color"]],["para",["ul","ol","paragraph"]],["table",["table"]],["insert",["link","image","video"]],["view",["fullscreen","codeview","help"]]],buttons:{image:function(){return $.summernote.ui.button({contents:'<i class="note-icon-picture" />',tooltip:$.summernote.lang[$.summernote.options.lang].image.image,click:function(){$("#modal-image").remove(),$.ajax({url:"index.php?route=common/filemanager&user_token="+bull5i.user_token,dataType:"html",beforeSend:function(){$("#button-image i").replaceWith('<i class="fa fa-circle-o-notch fa-spin"></i>'),$("#button-image").prop("disabled",!0)},complete:function(){$("#button-image i").replaceWith('<i class="fa fa-upload"></i>'),$("#button-image").prop("disabled",!1)},success:function(e){$("body").append('<div id="modal-image" class="modal">'+e+"</div>"),$("#modal-image").modal("show"),$("#modal-image").delegate("a.thumbnail","click",function(e){e.preventDefault(),$(t).summernote("insertImage",$(this).attr("href")),$("#modal-image").modal("hide")})}})}}).render()}},oninit:function(){$(".note-editable[contentEditable='false']").prop("contentEditable",!0)},onblur:function(){e=!0,"function"==typeof $(t).code?n($(t).code()):n($(t).summernote("code")),e=!1}}),$(t).summernote(l)},this.update=function(t,a,i){e||("function"==typeof $(t).code?$(t).code(ko.utils.unwrapObservable(i().value)):$(t).summernote("code",ko.utils.unwrapObservable(i().value)))}},ko.bindingHandlers.typeahead={init:function(e,t,a){var i=t(),l={};ko.utils.unwrapObservable(a()).value;ko.utils.extend(l,ko.bindingHandlers.typeahead.options),ko.utils.extend(l,i.options),$(e).typeahead(l,i.datasets)},options:{hint:!0,highlight:!0}},$.fn.dataTableExt){function localStorageUsable(){try{return localStorage.setItem("test","test"),localStorage.removeItem("test"),!0}catch(e){return!1}}function storeLocally(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(t){window&&window.console&&window.console.log&&window.console.log("Failed to save cache",e,t)}}$.fn.dataTable.pipeline=function(e){var t=$.extend({instance:"dT",pages:5,url:"",data:null,method:"POST"},e);bull5i.debugging&&console.log("dT.pipeline cache",t.pages,"pages");var a="pqep_"+t.instance+"_"+location.pathname,i=null,l=!1;if(localStorageUsable())try{var n=JSON.parse(localStorage.getItem(a));n&&n.user_token==bull5i.user_token&&+new Date-n.time<864e5&&(i=n,l=!0)}catch(e){}return bull5i.debugging&&console.log("dT.pipeline use local cache=",l),function(e,n,o){var s=!1,r=e.start,d=e.start,u=e.length,c=r+u,p={lower:-1,upper:null,drawStart:-1,lastRequest:null,lastJson:null,user_token:bull5i.user_token,time:+new Date};bull5i.debugging&&console.log("dT.request ",e.draw,"start",r,"length",u),l&&!bull5i.clearCache?(o.dataCache=p=i,bull5i.debugging&&console.log("dT.request use local cache",p)):o.dataCache?(p=o.dataCache,bull5i.debugging&&console.log("dT.request use settings data cache",p)):(o.dataCache=p,bull5i.debugging&&console.log("dT.request use empty data cache")),l=!1,bull5i.clearCache=!1,o.dataCacheInstance=a;var f=null!=p.lastJson&&p.lastJson.recordsTotal>0?p.lastJson.recordsTotal:0,h=o.clearCache||!1;if(o.clearCache?(s=!0,o.clearCache=!1,bull5i.debugging&&console.log("dT.request api clearCache")):!p.lastRequest||JSON.stringify(e.order)===JSON.stringify(p.lastRequest.order)&&JSON.stringify(e.columns)===JSON.stringify(p.lastRequest.columns)&&JSON.stringify(e.search)===JSON.stringify(p.lastRequest.search)?(p.lower<0||r<p.lower||c>p.upper)&&(s=!0,bull5i.debugging&&console.log("dT.request outside cached data (",p.lower,"-",p.upper,")")):(s=!0,h=!0,bull5i.debugging&&console.log("dT.request new properties (order/column/search)")),p.lastRequest=$.extend(!0,{},e),p.drawStart=d,s){var b,m,g;if(-1!=u?(bull5i.debugging&&console.log("dT.request current cache (",p.lower,"-",p.upper,")"),!h&&r<p.lower?(bull5i.debugging&&console.log("dT.request < cache"),r-=u*(t.pages-1),g=u*t.pages,r<0&&(r=0),b=r,m=r+g,!h&&m>p.lower&&p.upper&&m<=p.upper&&(g=p.lower-r),bull5i.debugging&&console.log("dT.request from",r,"+",g)):(bull5i.debugging&&console.log("dT.request > cache, clearCache=",h),g=u*t.pages,b=r,m=r+g,!h&&f&&p.upper&&r+g>f&&(m=Math.ceil(f/u)*u,b=m-g),b<0&&(b=0,g=m)),e.start=b,e.length=g,bull5i.debugging&&console.log("dT.request from",e.start,"+",e.length)):(bull5i.debugging&&console.log("dT.request all products"),p.lower=b=r,p.upper=m=r+u*t.pages),$.isFunction(t.data)){var v=t.data(e);v&&$.extend(e,v)}else $.isPlainObject(t.data)&&$.extend(e,t.data);o.jqXHR=$.ajax({type:t.method,url:t.url,data:e,dataType:"json",cache:!1}).done(function(e){p.lower<0&&(p.lower=b),b>p.upper||m<p.lower||-1==u||h?-1==u&&(m=e.data.length):p.lastJson&&(bull5i.debugging&&console.log("dT.request modify cache"),b<p.lower?(e.data=$.merge(e.data,p.lastJson.data),e.data.splice(m-b,p.upper-m),bull5i.debugging&&console.log("dT.request prepend to cache (new=",b,"-",m,", old=",p.lower,"-",p.upper,")")):(e.data=$.merge(p.lastJson.data,e.data),e.data.splice(0,b-p.lower),bull5i.debugging&&console.log("dT.request append to cache (new=",b,"-",m,", old=",p.lower,"-",p.upper,")"))),bull5i.debugging&&console.log("dT.request new cache (",b,"-",m,")"),p.lastJson=$.extend(!0,{},e),p.lower=b,p.upper=m,p.time=+new Date,p.lower!=d&&e.data.splice(0,d-p.lower),-1!=u&&e.data.splice(u,e.data.length),n(e),storeLocally(a,p)}).fail(function(e,t,a){bull5i.display_alert&&bull5i.display_alert($("#alerts"),bull5i.texts.error_ajax_request,"error",0),window&&window.console&&window.console.log&&window.console.log(e,t,a),n(p.lastJson)})}else json=$.extend(!0,{},p.lastJson),json.draw=e.draw,json.data.splice(0,r-p.lower),-1!=u&&json.data.splice(u,json.data.length),bull5i.debugging&&console.log("dT.request serve from cache (",p.lower,"-",p.upper,")"),n(json)}},$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}),$.fn.dataTable.Api.register("updatePipeline()",function(e,t){return this.iterator("table",function(a){var i=a.dataCache;i&&i.lower>=0&&e+i.drawStart>=i.lower&&e+i.drawStart<=i.upper&&$.isPlainObject(t)&&(a.dataCache.lastJson.data[e+i.drawStart]=$.extend(!0,{},t),a.dataCacheInstance&&storeLocally(a.dataCacheInstance,a.dataCache))})}),bull5i.get_pk_params=function(){if(bull5i.dtApi==undefined)return null;var e=bull5i.dtApi.cell(this).data(),t=bull5i.dtApi.cell(this).index().row,a=bull5i.dtApi.cell(this).index().column,i=bull5i.dtApi.row(t).data().id,l=bull5i.dtApi.column(a).dataSrc(),n={};return n.id=i,n.column=l,n.old=e,n.id!=undefined&&n.column!=undefined?n:null}}if(bull5i.processing==undefined){var clients=[];bull5i.processing=function(e,t){e=e==undefined||e,t=t==undefined?"general":t;var a=$("#dT_processing");if(a.length){if(e)-1===clients.indexOf(t)&&clients.push(t);else{var i=clients.indexOf(t);-1!==i&&clients.splice(i,1)}if(clients.length>0)a.css("display","block"),setTimeout(function(){a.addClass("in")},0);else{function l(){a.css("display","none")}a.removeClass("in"),$.support.transition&&a.hasClass("fade")?a.one($.support.transition.end,l).emulateTransitionEnd(500):l()}}}}bull5i.display_alert==undefined&&(bull5i.display_alert=function(e,t,a,i,l){i=i!=undefined?i:1e4,l=l==undefined||l;var n,o=e||$("#alerts"),s=[];t&&o.length&&(l&&(s=$.map($(".alert",o),function(e){var t=$.Deferred();return $(e).alert("close").on("closed.bs.alert",function(){t.resolve()}),t.promise()})),$.when.apply(null,s).done(function(){a in bull5i.alert_classes||(a="error"),n=(n=$("<div/>",{class:"alert "+bull5i.alert_classes[a]+" fade"}).html(t).prepend($("<i/>",{class:"fa "+bull5i.alert_icons[a]})).prepend($("<button/>",{type:"button",class:"close","data-dismiss":"alert","aria-hidden":"true"}).html("&times;"))).appendTo(o),setTimeout(function(){n.addClass("in")},0),i&&setTimeout(function(){n.alert("close")},i)}))}),bull5i.update_nav_controls==undefined&&(bull5i.update_nav_controls=function(e){(e=e!=undefined&&e)?$("#bull5i-navbar :input").prop("disabled",!0):($("#bull5i-navbar :input").prop("disabled",!1),$("input[name*='selected']:checked").length?($("#btn-delete").prop("disabled",!1),$("#btn-copy").prop("disabled",!1),$("input[name*='selected']:checked").length>1?$("#batch-edit-container").removeClass("hidden"):$("#batch-edit-container").addClass("hidden")):($("#btn-delete").prop("disabled",!0),$("#btn-copy").prop("disabled",!0),$("#batch-edit-container").addClass("hidden")))}),bull5i.update_nav_checkboxes==undefined&&(bull5i.update_nav_checkboxes=function(){$.each(selected_state,function(e,t){$("input[name*='selected'][value='"+t+"']").prop("checked",!0)})}),bull5i.display_alerts==undefined&&(bull5i.display_alerts=function(e,t,a){t=t==undefined||t,a=a!=undefined?a:$("#alerts");Object.values(e).flat().length?$.each(e,function(e,i){"object"==typeof i?$.each(i,function(i,l){l&&(bull5i.display_alert(a,l,e,"success"==e?bull5i.success_timeout:0,t),t=!1)}):i&&(bull5i.display_alert(a,i,e,"success"==e?bull5i.success_timeout:0,t),t=!1)}):bull5i.clear_alerts(a)}),bull5i.clear_alerts==undefined&&(bull5i.clear_alerts=function(e){var t,a=e||$("#alerts");a.length&&(t=$.map($(".alert",a),function(e){var t=$.Deferred();return $(e).alert("close").on("closed.bs.alert",function(){t.resolve()}),t.promise()}),$.when.apply(null,t))}),bull5i.update_special_price_menu==undefined&&(bull5i.update_special_price_menu=function(e){var t=e.data("value"),a=$("#filter_special_price"),i=$("#filter_price");t!=undefined&&a.length&&i.length&&(a.val(t),i.val(t),e.closest("ul").find("li.active").removeClass("active"),e.closest("ul").find("i.fa-check").removeClass("fa-check"),e.closest("li").addClass("active"),e.find("i.fa").addClass("fa-check"),""==t?i.prop("disabled",!1):i.prop("disabled",!0))}),bull5i.validate_datetime==undefined&&(bull5i.validate_datetime=function(e){var t=this.format!=undefined?this.format:"YYYY-MM-DD";""==e||moment(e,t).isValid()?(this.target.hasError(!1),this.target.errorMsg("")):(this.target.hasError(!0),this.target.errorMsg(this.message))}),bull5i.observable_object_methods=function(){this.hasError=function(){var e=!1;for(var t in this)ko.isObservable(this[t])&&"function"==typeof this[t].hasError&&(e|=this[t].hasError());return e},this.applyErrors=function(e){for(var t in this)ko.isObservable(this[t])&&("function"==typeof this[t].applyErrors?this[t].applyErrors(e.hasOwnProperty(t)?e[t]:{}):("function"==typeof this[t].hasError&&ko.isWriteableObservable(this[t].hasError)&&this[t].hasError(e.hasOwnProperty(t)),"function"==typeof this[t].errorMsg&&ko.isWriteableObservable(this[t].errorMsg)&&this[t].errorMsg(e.hasOwnProperty(t)?e[t]:"")))},this.updateValues=function(e){for(var t in this)ko.isWriteableObservable(this[t])&&e.hasOwnProperty(t)&&("function"==typeof this[t].updateValues?this[t].updateValues(e[t]):this[t](e[t]))}},bull5i.get_additional_params=function(){return params=bull5i.params,bull5i.params={},params},bull5i.form_add=function(){bull5i.params.add=!0,delete bull5i.params.remove},bull5i.form_remove=function(){bull5i.params.remove=!0,delete bull5i.params.add},bull5i.form_overwrite=function(){delete bull5i.params.add,delete bull5i.params.remove},$(function(){var start_time,pinitButtons=$.fn.editableform.Constructor.prototype.initButtons;function ajax_success(data){if(data){if(this.vm&&data.values&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].updateValues&&bull5i.view_models[this.vm].updateValues(data.values),this.vm&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].applyErrors&&bull5i.view_models[this.vm].applyErrors(data.errors?data.errors:{}),bull5i.display_alerts(data.alerts,!0,this.alerts),data.callback)try{eval(data.callback)}catch(e){}data.reload?window.location.reload(!0):data.url&&(window.location=data.url),data.reset&&bull5i.dtApi!=undefined?bull5i.dtApi.draw():bull5i.dtApi!=undefined&&bull5i.dtApi.draw(!1),this.dfd&&this.dfd.resolve()}}function update_path(e){if(window.history&&history.pushState){var t=window.location,a=t.protocol+"//"+t.host+t.pathname,i=$.query.load(location.href).remove("dTc");for(var l in e)i=i.remove(l),e[l]&&(i=i.set(l,e[l]));i=i.set("dTc",1),window.history.replaceState(null,null,a+i.toString(["route"]))}}function search(e){bull5i.dtApi!=undefined&&(bull5i.dtApi.search(e).draw(),update_path({search:e,page:0}))}function filter(){if(bull5i.dtApi!=undefined){var e={};$("tr.filters .fltr:input").not(".typeahead.id_based").each(function(t){var a=$(this).attr("data-column");if(a!=undefined){var i=$(this).val();bull5i.dtApi.column(a+":name").search(i),e["filter_"+a]=i}}),bull5i.dtApi.draw(),e.page=0,update_path(e)}}$.extend($.fn.editableform.Constructor.prototype,{initButtons:function(){if("buttons"in this.options){var e=this.$form.find(".editable-buttons");e.append(this.options.buttons),this.$form.find(".editable-add").click($.proxy(function(){bull5i.form_add(),this.$form.submit()},this)),this.$form.find(".editable-remove").click($.proxy(function(){bull5i.form_remove(),this.$form.submit()},this)),this.$form.find(".editable-overwrite").click($.proxy(function(){bull5i.form_overwrite(),this.$form.submit()},this)),"bottom"===this.options.showbuttons&&e.addClass("editable-buttons-bottom")}else pinitButtons.apply(this)}}),$.fn.editableform.loading='<div class="editableform-loading bull5i-container"><div class="content-overlay in"><i class="fa fa-refresh fa-spin fa-2x text-muted"></i></div></div>',$.fn.editableform.clear='<span class="editable-clear-x"><i class="fa fa-times-circle"></i></span>',$.fn.editableform.buttons='<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-remove"></i></button>',bull5i.ajax_fail=function(e,t,a){bull5i.display_alert&&bull5i.display_alert(this.alerts,bull5i.texts.error_ajax_request,"error",0),this.dfd&&this.dfd.reject(),window&&window.console&&window.console.log&&window.console.log(e,t,a)},bull5i.ajax_always=function(e,t,a){bull5i.update_nav_controls(!1),this.btn&&(this.btn.data("loading-text")?this.btn.button("reset"):this.btn.prop("disabled",!1)),this.form&&$("fieldset",this.form).attr("disabled",!1)},$(document).ajaxStart(function(){start_time=(new Date).getTime()}).ajaxComplete(function(e,t,a){if(bull5i.texts.text_request_handled){var i=bull5i.texts.text_request_handled.replace("_PAGE_TIME_",(((new Date).getTime()-start_time)/1e3).toFixed(3));i=t.responseJSON&&t.responseJSON.query_count?i.replace("_QUERY_COUNT_",t.responseJSON.query_count):i.replace("_QUERY_COUNT_","?"),$("#ajax-request-container").html(i)}}),$("#dT").on("init.dt",function(e,t,a){if(bull5i.dtApi=new $.fn.dataTable.Api(t),bull5i.dtApi!=undefined&&$.query.get("dTc")){var i=bull5i.dtApi.page.info(),l={};l.search=bull5i.dtApi.search(),$("tr.filters .fltr:input").each(function(e){var t=$(this).attr("data-column");if(t!=undefined){var a=$(this).val();l["filter_"+t]=a}}),i.page?l.page=i.page+1:l.page=0,update_path(l)}}).on("processing.dt",function(e,t,a){bull5i.processing(a,"dT")}).on("page.dt",function(e,t){if(bull5i.dtApi!=undefined){var a=bull5i.dtApi.page.info(),i={};a.page?i.page=a.page+1:i.page=0,update_path(i)}}).on("draw.dt",function(e,t){var a=bull5i.dtApi||new $.fn.dataTable.Api(t);bull5i.highlight_filtered_columns?($("th",a.table().header()).removeClass("info"),a.columns().eq(0).each(function(e){""!=a.column(e).search()&&($(a.column(e).nodes()).addClass("info"),$(a.column(e).header()).addClass("info"),$("tr.filters",a.table().header()).children().eq(e).addClass("info"))})):$("th",a.table().header()).removeClass("info")}),$("body").on("click",".modal-footer .cancel",function(e){jqXHR&&jqXHR.abort()}).on("click","#dT-selector",function(e){$("input[name*='selected']").prop("checked",this.checked).trigger("change")}).on("change","input[name*='selected']",function(e){selected_state=$("input[name*='selected']").serializeObject().selected||[],bull5i.update_nav_controls()}).on("change","select.view_in_store",function(e){$(this).val()&&(window.open(this.value),this.value="")}).on("click",".filter-special-price",function(e){bull5i.update_special_price_menu($(this))}).on("click","#global-search-btn",function(e){var t=ko.contextFor(this),a=$("#global-search").val();t.$root.setSearch(a),search(a)}).on("click","#clear-global-search-btn",function(e){ko.contextFor(this).$root.setSearch(""),$("#global-search").val(""),search("")}).on("click","#btn-search-bar",function(e){var t=bull5i.view_models.otherSettingsVM.module_product_quick_edit_search_bar;t("1"==t()?"0":"1")}).on("keypress","#global-search",function(e){if(13==e.which){var t=ko.contextFor(this),a=$("#global-search").val();t.$root.setSearch(a),search(a)}}).on("click","#clear-filter",function(e){bull5i.update_special_price_menu($("#special-price-off")),$("tr.filters .fltr:input").not(".typeahead").val(""),$("tr.filters .typeahead.fltr:input").typeahead("val",""),$("tr.filters .typeahead.id_based.fltr:input").removeData("ta-selected").removeData("ta-name"),filter()}).on("keypress","tr.filters .fltr:input",function(e){if(13==e.which){if($(this).is(".typeahead.id_based")&&""!=$(this).val()&&($(this).data("ta-selected")==undefined||$(this).val()!=$(this).data("ta-selected").value))return;$(this).is(".typeahead.id_based")&&""==$(this).val()&&($(this).typeahead("val",""),$(this).closest("th").find("input[type=hidden][data-column="+$(this).data("ta-name")+"]").val(""),$(this).removeData("ta-selected"),$(this).removeData("ta-name")),filter()}}).on("click","#filter",function(e){filter()}).on("click","#btn-delete",function(e){var t=!1,a=$.Deferred();$form=$($(this).data("form")),options={self:this,btn:$(this),form:$form,url:$(this).data("url"),alerts:$("#alerts"),context:$($(this).data("context"))},e.preventDefault(),options.url&&options.form&&($("#confirmDelete").length?($("#confirmDelete").modal("show"),$("#confirmDelete button.delete").click(function(){$("#confirmDelete").modal("hide"),t=!0}),$("#confirmDelete").on("hidden.bs.modal",function(){t?a.resolve():a.reject()})):a.resolve(),a.done(function(){jqXHR=$.ajax({type:"POST",url:options.url,dataType:"json",data:options.form.serialize(),beforeSend:function(){options.btn.data("loading-text")?options.btn.button("loading"):options.btn.prop("disabled",!0),$("fieldset",options.form).attr("disabled",!0)}}).done(function(e){bull5i.dtApi!=undefined&&bull5i.dtApi.clearPipeline(),ajax_success.call(options,e)}).fail($.proxy(bull5i.ajax_fail,options)).always($.proxy(bull5i.ajax_always,options))}))}).on("click","#btn-copy",function(e){var t=$($(this).data("form")),a={self:this,btn:$(this),form:t,url:$(this).data("url"),alerts:$("#alerts"),context:$($(this).data("context"))};e.preventDefault(),a.url&&a.form&&(jqXHR=$.ajax({type:"POST",url:a.url,dataType:"json",data:a.form.serialize(),beforeSend:function(){a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0),$("fieldset",a.form).attr("disabled",!0)}}).done(function(e){bull5i.dtApi!=undefined&&bull5i.dtApi.clearPipeline(),ajax_success.call(a,e)}).fail($.proxy(bull5i.ajax_fail,a)).always($.proxy(bull5i.ajax_always,a)))}).on("click","#btn-insert,.btn.edit",function(e){var t=$(this).data("url");t&&(window.location=t)}).on("click",".modal-footer .submit",function(e){var t=$($(this).data("form")),a={self:this,btn:$(this),form:t,url:t!=undefined?t.attr("action"):null,vm:$(this).data("vm"),alerts:$("div.notice",$($(this).data("context")))||$("#alerts"),context:$($(this).data("context"))};e.preventDefault(),a.url&&(jqXHR=$.ajax({type:"POST",url:a.url,dataType:"json",data:a.form.serialize(),beforeSend:function(){a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0),$("fieldset",a.form).attr("disabled",!0)}}).done($.proxy(ajax_success,a)).fail($.proxy(bull5i.ajax_fail,a)).always($.proxy(bull5i.ajax_always,a)))}).on("click","#clearCache",function(e){$($(this).data("form"));var t={self:this,url:this.href,vm:"",alerts:$("#alerts"),context:$("#content")};e.preventDefault(),t.url&&(jqXHR=$.ajax({type:"POST",url:t.url,dataType:"json",data:t.form!=undefined?t.form.serialize():t.params!=undefined?t.params:{},beforeSend:function(){bull5i.processing(!0,"clear_cache"),bull5i.update_nav_controls(!0)}}).done(function(e){bull5i.dtApi!=undefined&&bull5i.dtApi.clearPipeline(),ajax_success.call(t,e)}).fail($.proxy(bull5i.ajax_fail,t)).always(function(e,a,i){bull5i.processing(!1,"clear_cache"),bull5i.ajax_always.call(t,e,a,i)}))}).on("click",".btn-clear-image",function(){var e=ko.contextFor(this);e.$root.clearImage(e),$(this).closest(".popover").popover("hide")}).on("click",".btn-browse-image",function(){var e=ko.contextFor(this),t=this;$(t).button("loading"),e.$root.browseImage(e).done(function(){$(t).button("reset"),$(t).closest(".popover").popover("hide")})}),$(".typeahead.id_based").on("typeahead:select typeahead:autocomplete",function(e,t){var a=$(this).closest("th").find("input[type=hidden][data-column]").data("column");$(this).data("ta-selected",t).data("ta-name",a),$(this).closest("th").find("input[type=hidden][data-column]").val(t.id),$(this).val()!=t.value&&$(this).typeahead("val",t.value)}).on("typeahead:close",function(){$(this).data("ta-selected")==undefined?$(this).typeahead("val",""):$(this).val()!=$(this).data("ta-selected").value&&($(this).typeahead("val",""),$(this).closest("th").find("input[type=hidden][data-column="+$(this).data("ta-name")+"]").val(""),$(this).removeData("ta-selected"),$(this).removeData("ta-name"))}),$("body").on("typeahead:select","#qe-options .options.typeahead",function(e,t){ko.contextFor(this).$root.addOption(t)}),$("body").on("typeahead:select typeahead:autocomplete","#qe-attributes .attributes.typeahead",function(e,t){var a=$(this).closest("td").find("input[type=hidden][data-column]").data("column"),i=ko.contextFor(this);$(this).data("ta-selected",t).data("ta-name",a),i.$data.id(t.id),i.$data.name(t.value),$(this).val()!=t.value&&$(this).typeahead("val",t.value)}).on("typeahead:close","#qe-attributes .attributes.typeahead",function(){var e=ko.contextFor(this);$(this).data("ta-selected")!=undefined&&$(this).val()!=$(this).data("ta-selected").value&&($(this).typeahead("val",""),$(this).removeData("ta-selected"),$(this).removeData("ta-name"),e.$data.id(null),e.$data.name(""))}),$("#alerts .alert.alert-success").each(function(e){var t=$(this);setTimeout(function(){t.alert("close")},8e3)})})}(window.bull5i=window.bull5i||{},jQuery);
